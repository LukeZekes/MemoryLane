...
define gui.idle_color = u'#3B3B3B'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = u'#3B3B3B'
...
define gui.selected_color = u'#000000'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = u'#3B3B3B'
...
define gui.text_font = "typewriter/TYPEWR__.TTF"

## The font used for character names.
define gui.name_text_font = "typewriter/TYPEWR__.ttf"
## The font used for out-of-game text.
define gui.interface_text_font = "typewriter/TYPEWR__.ttf"
...
define gui.dialogue_width = 800 #744
...
define gui.choice_button_text_idle_color = "#262626"
